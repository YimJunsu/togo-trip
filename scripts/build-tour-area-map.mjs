...
const MANUAL_OVERRIDES = {
  ...
  // 청주시 4개 구 — TourAPI는 나누지 않는다. 청원구를 옛 '청원군'(9)에 붙였다가
  // 0건이 나와 고쳤다. 실측(2026-08-03): (33,9) 0건 / (33,10) 63건.
  // TourAPI는 통합 이전 코드를 목록에 남겨 두지만 데이터는 통합시로 옮겨 갔다.
  '33041': [33, 10], // 청주시 상당구
  '33042': [33, 10], // 청주시 서원구
  '33043': [33, 10], // 청주시 흥덕구
  '33044': [33, 10], // 청주시 청원구
  ...
  // 창원시 5개 구 — 2010년 마산시·진해시와 통합했다. TourAPI 목록에는 옛
  // 마산시(6)·진해시(14) 코드가 남아 있지만 데이터는 전부 창원시(16)로 옮겨 갔다.
  // 옛 코드에 붙였다가 0건이 나와 고쳤다. 실측(2026-08-03):
  // (36,6) 0건 / (36,14) 0건 / (36,16) 107건.
  '38111': [36, 16], // 창원시 의창구
  '38112': [36, 16], // 창원시 성산구
  '38113': [36, 16], // 창원시 마산합포구
  '38114': [36, 16], // 창원시 마산회원구
  '38115': [36, 16], // 창원시 진해구
}
