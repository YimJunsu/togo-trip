 ...
 *
 * TODO(운영): 배포 전에 실제 값으로 채운다. 개인 운영이라 사업자등록번호·통신판매업
 * 신고번호는 두지 않지만, **이름과 연락 가능한 이메일은 법적으로 생략할 수 없다.**
 * 연락처가 없으면 이용자가 열람·삭제를 요구할 통로가 사라진다.
 */
export const OPERATOR = {
  /** 개인 운영. 사업자등록 시 상호로 바꾸고 등록번호 항목을 추가한다. */
  type: '개인',
  name: 'TODO_운영자_성명',
  /** 문의·열람·삭제 요청을 실제로 받는 주소여야 한다. */
  email: 'TODO@togo-trip.com',
} as const
